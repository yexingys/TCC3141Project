...
Body mass index (BMI) is a calculation of weight and height, calculated as weight in kilograms (kg) divided by the square of height in meters (m) [1]. Besides that, BMI score will give an indirect measure of body fat to determine that the user may be underweight, healthy weight, overweight or obese. In addition, from a recent article [2] can be figured out that the BMI had became a popular choice for user to monitor health condition. Hence, it could be a simple tool for user to calculate and it is inexpensive tool for healthcare.  
In the other hand, users shall not fully depend on BMI to monitor their health condition, even though is it an alternative to keep track of user’s health condition. Users could also need to be realise that different lifestyle habits and genetic diseases can cause different health problem. Moreover, some articles and studies [3][4][5] points out that particular users that are low BMI might experience in bad health, which could be due to having cloth of fats in a certain organ of body that will bring harm to health. So, the user who has a higher BMI does not mean that is overweight but having a healthy level of fats.
